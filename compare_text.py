...
plt.legend()
plt.title("Permutation Test on Word Distributions: " + plotname)
...
plt.ylabel('Frequency')
plt.legend()
plt.title("Bootstrap Distribution of φ: " + plotname)
...
plt.xlabel("p-value")
plt.ylabel("Frequency")
plt.title("Histogram of Permutation Test p-values: " + plotname)
...
plt.title(f'Top {top_n} Contributing Words: ' + plotname)
